    ...
    <div className="flex flex-col w-full items-start space-y-4 py-6 pl-4">
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center justify-center text-5xl group relative">
          ...
          <div className="pointer-events-none absolute left-1/2 top-full -translate-x-1/2 mt-2 opacity-0 group-hover:opacity-100 transition duration-200">
            <div className="relative bg-popover/95 backdrop-blur-md text-popover-foreground text-sm leading-snug rounded-lg shadow-lg border px-3 py-2.5 max-w-[240px] w-[220px] text-left whitespace-normal break-words">
              {/* Arrow */}
              <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-2.5 h-2.5 bg-popover/95 border-l border-t border-border rotate-45 rounded-[2px]" />
              {feedback}
            </div>
          </div>
        </div>
